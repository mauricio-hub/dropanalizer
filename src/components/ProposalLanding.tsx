...
export default function ProposalLanding({ proposal, version }: ProposalLandingProps) {
  ...
  const sectionRefs = useRef<Record<string, { element: HTMLElement; startTime: number | null; totalTime: number }>>({
    hero: { element: null as any, startTime: null, totalTime: 0 },
    scope: { element: null as any, startTime: null, totalTime: 0 },
    deliverables: { element: null as any, startTime: null, totalTime: 0 },
    timeline: { element: null as any, startTime: null, totalTime: 0 },
    pricing: { element: null as any, startTime: null, totalTime: 0 },
    cta: { element: null as any, startTime: null, totalTime: 0 },
  })
  ...
  useEffect(() => {
    ...
    // Cleanup function to track remaining time
    return () => {
      observer.disconnect()
